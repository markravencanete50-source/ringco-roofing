...
export default function CtaBand() {
  return (
    <section className="relative overflow-hidden bg-[radial-gradient(120%_120%_at_80%_0%,oklch(0.24_0.04_45)_0%,oklch(0.14_0.02_50)_60%)] px-[6vw] py-28">
      ...
      <Aurora
        orbs={[
          { color: 'var(--accent)', size: 560, top: '-30%', right: '8%', opacity: 0.22, motion: 'drift', duration: 28 },
          { color: 'var(--blue)', size: 480, bottom: '-30%', left: '4%', opacity: 0.14, motion: 'float', duration: 24 },
        ]}
      />

      <div className="relative z-10 mx-auto max-w-wrap text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <Magnetic><Button href="/contact" className="!px-8 !py-4 !text-[16px]">Book my free inspection</Button></Magnetic>
